...
* If p-value < 0.05, we reject the null hypothesis and conclude the feature is statistically significant, so we keep it.
* If p-value > 0.05, we fail to reject the null hypothesis and consider removing the feature because it is not statistically significant.
