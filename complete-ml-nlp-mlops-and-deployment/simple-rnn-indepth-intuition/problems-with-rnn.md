...
* So when we multiply this small terms the gradient will almost be 0, so we can say that the word is not participating in weight updation
* The words which are nearer to the output they will contribute in weight updation
*   And the weights wont be updated

    <figure><img src="../../.gitbook/assets/{3EA0943B-24E6-4A61-8188-AFDB92B3064B}.png" alt=""><figcaption></figcaption></figure>
* To solve this we can also other activation functions like ReLU, Leaky ReLU
* Another option is to use LSTM
